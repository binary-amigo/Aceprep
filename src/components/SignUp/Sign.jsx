...
const SignUpCard = () => {
  return (
    <div className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900 via-gray-100 to-blue-900 flex justify-center items-center h-screen fixed-div ">
      {/* Sign Up Card */}
      <div className="max-w-lg w-full py- bg-white  shadow-md bg-opacity-30 backdrop-blur-sm rounded-3xl">
        <div className="flex flex-col items-center ">
          ...
          <form className="space-y-2 h-auto mx-2">
                <div className="flex items-center   rounded-full px-12 py-2 bg-[#e8ebf2] hover:bg-white transition duration-300">
            ...
            <button type="submit" className="w-full bg-blue-600 text-white rounded-full py-2 hover:bg-blue-700">Sign Up</button>
          </form>

          <div className="text-center justify-between items-center mt-2 w-80 ">
            <p>Already have an account? <a href="#" className="text-blue-600">Sign In</a></p>
           <button
            onClick={() => login()}
